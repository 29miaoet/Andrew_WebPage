...
document.getElementById("downloadBtn3").addEventListener("click", (e) => {
    downloadFile("https://github.com/29miaoet/Andrew_WebPage/archive/refs/tags/v28.1.2.zip");
});

// Source code download, tarball archive.
document.getElementById("downloadBtn4").addEventListener("click", (e) => {
    downloadFile("https://github.com/29miaoet/Andrew_WebPage/archive/refs/tags/v28.1.2.tar.gz");
});
